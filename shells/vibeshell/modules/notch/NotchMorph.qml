...
Item {
    ...
    readonly property color verm: Colors.primary
    readonly property color vermLit: Colors.primaryFixedDim
    readonly property color flameInk: Qt.lighter(Colors.primaryFixed, 1.08)
    readonly property color flameCore: Colors.tertiaryFixed
    readonly property color flameTip: Qt.tint(Colors.tertiaryFixed, Qt.rgba(1, 1, 1, 0.22))
    readonly property color flameBurn: Qt.darker(Colors.primary, 1.35)
    readonly property color flameEmber: Qt.darker(Colors.primaryContainer, 1.12)
    ...
    Canvas {
        ...
        function bead(ctx, x, y, R, stretch, ang, alpha) {
            ...
            hg.addColorStop(0, root.flameInk);
            hg.addColorStop(0.55, root.vermLit);
            hg.addColorStop(0.92, root.verm);
            hg.addColorStop(1, root.flameEmber);
            ctx.beginPath();
            ctx.arc(0, 0, R, 0, 7);
            ctx.fillStyle = hg;
            ctx.fill();
            ...
            for (let k = 0; k < 2; k++) {
                ...
                ctx.strokeStyle = k ? root.flameBurn : root.flameTip;
        ...
        onPaint: {
            ...
            if (root.phase === "fly") {
                ...
                for (let i = 0; i < NSEG; i++) {
                    ...
                    ctx.strokeStyle = fI > 0.6 ? root.vermLit : root.verm;
            ...
            if (f === "caret") {
                ...
                cg.addColorStop(0, root.flameCore);
                cg.addColorStop(1, root.vermLit);
                ctx.fillStyle = cg;
                ctx.fill();
                ctx.globalAlpha = 1;
                return;
            ...
            if (f === "tick") {
                ...
                tg.addColorStop(0, root.flameInk);
                tg.addColorStop(0.55, root.vermLit);
                tg.addColorStop(0.92, root.verm);
                tg.addColorStop(1, root.flameEmber);
                ctx.beginPath();
                ctx.arc(0, 0, ry, 0, 7);
                ctx.fillStyle = tg;
            ...
            if (f === "rowseam") {
                ...
                sg3.addColorStop(0.5, root.flameInk);
